        ...
        <table class="table">
            ...
            <tbody class="table-border-bottom-0">
                ...
                <tr class="table-warning">
                    <td><i class="bx bxl-react bx-sm text-info me-3"></i> <span class="fw-medium">React Custom</span>
                    </td>
                    <td>Ted Richer</td>
                    <td>
                        <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                ...
                <tr class="table-light">
                    <td><i class="bx bxl-angular bx-sm text-danger me-3"></i> <span class="fw-medium">Angular UI</span>
                    </td>
                    <td>Ana Bell</td>
                    <td>
                        <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
...
<div class="table-responsive text-nowrap">
    <table class="table card-table">
        ...
        <tbody class="table-border-bottom-0">
            ...
            <tr>
                <td><i class="bx bxl-vuejs bx-sm text-success me-3"></i> <span class="fw-medium">VueJs Project</span>
                </td>
                <td>Trevor Baker</td>
                <td>
                    <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
