...
<head>
    ...
    <link rel="preload" href="{{ url('vista/script.js?v=1716452615718') }}" as="script"/>
    <link rel="preload" href="{{ url('vista/media/panorama_AE93AFF1_A427_DFA3_41B8_9F48F2916304_0/l/4/0_0.jpg?v=1716452615718') }}" as="image"/>
    <link rel="preload" href="{{ url('vista/media/panorama_AE93AFF1_A427_DFA3_41B8_9F48F2916304_0/r/4/0_0.jpg?v=1716452615718') }}" as="image"/>
    <link rel="preload" href="{{ url('vista/media/panorama_AE93AFF1_A427_DFA3_41B8_9F48F2916304_0/u/4/0_0.jpg?v=1716452615718') }}" as="image"/>
    <link rel="preload" href="{{ url('vista/media/panorama_AE93AFF1_A427_DFA3_41B8_9F48F2916304_0/d/4/0_0.jpg?v=1716452615718') }}" as="image"/>
    <link rel="preload" href="{{ url('vista/media/panorama_AE93AFF1_A427_DFA3_41B8_9F48F2916304_0/f/4/0_0.jpg?v=1716452615718') }}" as="image"/>
    <link rel="preload" href="{{ url('vista/media/panorama_AE93AFF1_A427_DFA3_41B8_9F48F2916304_0/b/4/0_0.jpg?v=1716452615718') }}" as="image"/>
    ...
    <script src="{{ url('vista/lib/tdvplayer.js?v=1716452615718') }}"></script>
    <script type="text/javascript">
        ...
        function loadTour()
        {
            ...
            settings.set(TDV.PlayerSettings.SCRIPT_URL, '/vista/script.js?v=1716452615718');
            settings.set(TDV.PlayerSettings.WEBVR_POLYFILL_URL, 'lib/WebVRPolyfill.js?v=1716452615718');
            settings.set(TDV.PlayerSettings.HLS_URL, 'lib/Hls.js?v=1716452615718');
            settings.set(TDV.PlayerSettings.QUERY_STRING_PARAMETERS, 'v=1716452615718');
...
<body onload="onLoad()">
    ...
    <div id="preloadContainer" style="background-color:rgba(255,255,255,1)"><div style="z-index: 4; position: absolute; left: 0%; top: 50%; width: 100.00%; height: 10.00%"><div style="text-align:left; color:#000; "><DIV STYLE="text-align:center;"><SPAN STYLE="letter-spacing:0vmin;color:#777777;font-size:1.39vmin;font-family:Arial, Helvetica, sans-serif;">Loading virtual tour. Please wait...</SPAN></DIV><p STYLE="margin:0; line-height:1.02vmin;"><BR STYLE="letter-spacing:0vmin;color:#000000;font-size:1.02vmin;font-family:Arial, Helvetica, sans-serif;"/></p><DIV STYLE="text-align:center;"><SPAN STYLE="letter-spacing:0vmin;color:#777777;font-size:1.39vmin;font-family:Arial, Helvetica, sans-serif;">created with the trial of 3DVista VT Pro</SPAN></DIV><p STYLE="margin:0; line-height:1.02vmin;"><BR STYLE="letter-spacing:0vmin;color:#000000;font-size:1.02vmin;font-family:Arial, Helvetica, sans-serif;"/></p><DIV STYLE="text-align:center;"><SPAN STYLE="letter-spacing:0vmin;color:#000000;font-size:1.02vmin;font-family:Arial, Helvetica, sans-serif;"><SPAN STYLE="color:#f3a22e;"><A HREF="http://www.3dvista.com" TARGET="_blank" STYLE="text-decoration:none; color:inherit;"><SPAN STYLE="color:#999999;font-size:1.3vmin;"><U>www.3DVista.com</U></SPAN></A></SPAN></SPAN></DIV></div></div></div>
    <div id="viewer"></div>
</body>
</html>